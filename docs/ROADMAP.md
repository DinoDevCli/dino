...
Shipped (v1.0.0): local-first proof engine, export contracts, proof index, Early Access Team Keys, fail-closed leakage scan, Codespaces, Superset starter kit, Developer Mode (`--dev`), CLI v1.0 UX (`dino run`, grouped help).
