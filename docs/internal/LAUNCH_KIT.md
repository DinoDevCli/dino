...
**Links:** GitHub https://github.com/DinoDevCli/dino · Release https://github.com/DinoDevCli/dino/releases · Website (Vercel) — set `NEXT_PUBLIC_*` and deploy `website/`
...
| # | Action | Status |
|---|--------|--------|
| 01 | GitHub Release v0.3.1 + release notes below | Run after push |
| 02 | Website deploy (Vercel: root `website`, env from `.env.example`) | Manual |
